...
| ✨ **매물 추천** | 가격·입지·투자가치·위험도 4축 점수 기반 추천 (현재 샘플 데이터 기반) |
...
│   ├── auth.db · history.db        사용자·이력 DB (자동 생성, Git 제외)
│   └── ...
├── tests/                          pytest 테스트 (17개 파일)
