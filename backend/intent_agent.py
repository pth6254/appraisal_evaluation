...
- location_normalized: 정규화된 행정구역명 문자열 (예: 서울시 마포구)
...
## 출력 예시
{"category":"주거용","category_detail":"아파트","location_raw":"마포구","location_normalized":"서울시 마포구","transaction_type":"매매","price_min":80000,"price_max":90000,"price_raw":"8억~9억","area_min":84.0,"area_max":84.0,"area_raw":"84㎡","special_conditions":[],"confidence":0.95,"missing_fields":[],"clarification_question":""}"""
